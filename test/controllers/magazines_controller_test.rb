...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { description: @magazine.description, name: @magazine.name, thumb: @magazine.thumb }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { description: @magazine.description, name: @magazine.name, thumb: @magazine.thumb }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
